...
import java.io.*;import java.util.*;import cat.quadriga.parsers.code.*;import cat.quadriga.parsers.code.statements.*;import cat.quadriga.parsers.code.expressions.*;import cat.quadriga.parsers.code.printers.*;import cat.quadriga.parsers.code.symbols.*;import cat.quadriga.parsers.code.types.*;
@ ()public class QuadrigaSimple implements {
  ...
  +- Code:
     ...
     +- >> Proxy Statement: 
        ...
        +-    |  +- Op: >> proxy [ System.out.println ]
        +-    +- St: >> unary proxy <<
        +-       +- Op: Access to member printToFile
        ...
        +-       +- Op: >> proxy [ System.out.println ]
        <<
  public Lcat.quadriga.parsers.code.expressions.ExpressionNode; symbolToExpression(Lcat.quadriga.parsers.code.symbols.BaseSymbol; , Lcat.quadriga.parsers.Token; , Lcat.quadriga.parsers.Token; )
  Block:
  +- Local Variables:
  +- Code:
     +- If Statement:
     ...
     |  |  +- Op: instanceof
     |  |     +- Op: >> proxy [ symbol ]
     |  |     +- Op: >> proxy [ Lcat.quadriga.parsers.code.symbols.LocalVariableSymbol; ]
     |  +- If Code:
     |     +- Block:
     |        +- Local Variables:
     |        +- Code:
     ...
     +- >> Proxy Statement: 
        +- return ;
        <<
  public Lcat.quadriga.parsers.code.expressions.ExpressionNode; accessToMember(Lcat.quadriga.parsers.code.expressions.ExpressionNode; , Ljava.lang.String; , Lcat.quadriga.parsers.Token; )
  Block:
  +- Local Variables:
  +- Code:
     +- >> Proxy Statement: 
        +- return ;
        <<
  public Lcat.quadriga.parsers.code.expressions.ExpressionNode; resolveName(<>Ljava.util.List; )
  Block:
  +- Local Variables:
  |  +- Symbol Var [first] Type [Lcat.quadriga.parsers.Token;]
  |  +- Symbol Var [it] Type [Ljava.util.Iterator;]
  ...
  +- Code:
     ...
     |  +- Op: >> proxy [ actual ]
     |  +- Op: >> unary proxy <<
     |     +- Op: Access to member next
     |        +- Op: Local variable access: it
     +- St: No operation
     +- St: No operation
     +- If Statement:
     |  +- Condition:
     ...
     |  +-    |     +- Op: Literal
     |  +-    |     |  +- Character: '.'
     |  +-    |     +- Op: >> proxy [ actual.image ]
     |  +-    +- St: =
     |  +-    |  +- Op: >> proxy [ symbol ]
     |  +-    |  +- Op: >> unary proxy <<
     |  +-    |     +- Op: >> proxy [ symbolTable.findSymbol ]
     |  +-    +- If Statement:
     |  +-       +- Condition:
     |  +-       |  +- Op: !=
     |  +-       |     +- Op: >> proxy [ symbol ]
     ...
     |  +-                   +- Op: >> proxy [ result ]
     |  +-                   +- Op: >> unary proxy <<
     |  +-                      +- Op: >> proxy [ symbolToExpression ]Block:
     |  +- +- Local Variables:
     |  +- +- Code:
     |  +-    +- St: =
     |  +-    |  +- Op: >> proxy [ actual ]
  ...
  +- Code:
     ...
     |  <<
     +- St: >> unary proxy <<
     |  +- Op: >> proxy [ symbolTable.addPackage ]
     +- St: >> unary proxy <<
        +- Op: >> proxy [ out.add ]
  ...
  +- Code:
     ...
     |  +-   +-    +- St: No operation
     |  +-   +-    +- St: >> unary proxy <<
     |  +-   +-       +- Op: >> proxy [ symbolTable.addGlobalSymbol ] catch(Ljava.lang.ClassNotFoundException; ) 
     |  +-   +- Block:
     |  +-   +- +- Local Variables:
     |  +-   +- |  +- Symbol Var [symbol] Type [Lcat.quadriga.parsers.code.symbols.BaseSymbol;]
     |  +-   +- +- Code:
     |  +-   +-    +- St: No operation
     |  +-   +-    +- St: >> unary proxy <<
     |  +-   +-       +- Op: >> proxy [ symbolTable.addGlobalSymbol ]
     |  +-   <<
     |  +- }
     |  <<
     +- St: >> unary proxy <<
  ...
  +- Code:
     ...
     |     +- Op: >> proxy [ jj_consume_token ]
     +- St: =
     |  +- Op: Access to member name
     |  |  +- Op: Local variable access: vai
     |  +- Op: >> proxy [ t.image ]
     +- St: =
     |  +- Op: Access to member type
     |  |  +- Op: Local variable access: vai
     |  +- Op: >> proxy [ type ]
     +- LABEL: label_12
     |  +- >> Proxy Statement: 
                             ...
                             +- Block:
                                ...
                                +- Code:
                                   +- >> Proxy Statement: 
                                      ...
                                      +- }
                                      <<
  final public Lcat.quadriga.parsers.code.expressions.LiteralData; Literal() throws 
  Block:
  +- Local Variables:
  +- Code:
     +- St: No operation
     ...
     +- >> Proxy Statement: 
        +- throw ;
        <<
  final public Lcat.quadriga.parsers.code.expressions.LiteralData; BooleanLiteral() throws 
  Block:
  +- Local Variables:
  +- Code:
     +- St: No operation
     ...
     +- >> Proxy Statement: 
        +- throw ;
        <<
  final public Lcat.quadriga.parsers.code.expressions.LiteralData; NullLiteral() throws 
  Block:
  +- Local Variables:
  +- Code:
     +- St: No operation
  ...
  +- Code:
     ...
     +- >> Proxy Statement: 
        +- throw ;
        <<
  final public Lcat.quadriga.parsers.code.statements.StatementList; LocalVariableDeclaration(<>Ljava.util.List; ) throws 
  Block:
  +- Local Variables:
  ...
  +- Code:
     ...
     +- St: >> unary proxy <<
        +- Op: >> proxy [ Statement ]
  final public ForInit(<>Ljava.util.List; ) throws 
  Block:
  +- Local Variables:
  +- Code:
     +- If Statement:
           ...
           +- Block:
              ...
              +- Code:
                 +- >> Proxy Statement: 
                    ...
                    +- }
                    <<
  final public StatementExpressionList(<>Ljava.util.List; ) throws 
  Block:
  +- Local Variables:
  |  +- Symbol Var [treeString] Type [Ljava.lang.String;]
  +- Code:
